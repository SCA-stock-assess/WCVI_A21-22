---
title: "Hobiton Chum assessment update - DRAFT"
output: 
...
The primary objective for sample collection is to assess the degree of straying from Nitinat Chum that may be occurring in Hobiton, followed by monitoring the age structure. In 2024, approximately 75 DNA samples were also collected as baseline samples for the Molecular Genetics Lab at PBS, with the hopes these samples may help refine the coast-wide Chum GSI baseline. 
