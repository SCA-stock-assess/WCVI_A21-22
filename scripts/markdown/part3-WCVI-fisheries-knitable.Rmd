...
# CREST BDWR ----------------------   ***fix path NEXT DAY TO THE NETWORK LOCATION! 
...
# ============================ FOS COMMERCIAL data ============================
fos.nit <- readxl::read_excel(path=here::here("data", "fisheries", "COMMERCIAL SALMON IN-SEASON CATCH ESTIMATES (IN PIECES) - INTERNAL USE ONLY.xlsx")) %>%
  filter(estimate_type!="Total", !grepl("applied filter", estimate_type, ignore.case=T))





# ============================ NITINAT HATCHERY biodata ============================
